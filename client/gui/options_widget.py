...
class StegControlPanel(QGroupBox):
    def __init__(self):
        super().__init__()
        ...
        self.settings_checkbox = QCheckBox("Use advanced settings?")


        self.vbox = QVBoxLayout()
        self.vbox.addWidget(self.algorithm_widget)
        self.vbox.addWidget(self.action_widget)
        self.vbox.addWidget(self.settings_checkbox)
        self.vbox.addStretch()

        self.algorithm_widget.currentIndexChanged.connect(self.update_action_widget)
